...
All notable project changes are recorded here. The project intends to use semantic versioning when releases begin.

## [Unreleased]

### Added

- Canonical Codex execution documents and Sprint 00/01 controls.
- Finalized-artifact catalog with file sizes, SHA-256 checksums, purpose, and canonical locations.
- Detailed project structure and package guide.
- Read-only categorized copies of research, specification, engineering, growth, presentation, prototype, and starter-pack artifacts.
- Extracted developer/agent starter pack as preserved reference material.
- Minimal accessible Next.js web shell and typed FastAPI health service.
